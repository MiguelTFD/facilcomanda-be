...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(OrderNotAttendableException.class)
    public ResponseEntity<Map<String, String>> handleOrderNotAttendableException(OrderNotAttendableException ex) {
        logger.warn("Order not attendable: {}", ex.getMessage());
        return buildErrorResponse(ex.getMessage(), HttpStatus.BAD_REQUEST);
    }
